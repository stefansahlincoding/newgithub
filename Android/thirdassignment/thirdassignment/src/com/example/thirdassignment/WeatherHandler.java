//File added by teacher as help file to project
...
public class WeatherHandler extends DefaultHandler{
	...
	public static WeatherReport getWeatherReport(URL url, String _city) {
		city = _city;
	...
	public void startDocument() throws SAXException {
		...
		//report = new WeatherReport("Alvesta", "Sweden");
		report = new WeatherReport(city, "Sweden");
